...
shell = (function(){
	...
	jqueryMap = {},
	copyAnchorMap, setJqueryMap, updateData,  
  changeAnchorPart, onHashchange, onClickSwitches, 
  initModule;
  ...
  setJqueryMap = function(){
    ...
    jqueryMap = {
      $container
      $checkboxes: $container.find('.checkboxes')
    };
  };
  // End DOM method /setJqueryMap/


  // Begin DOM method /updateData/
  updateData = function(){
    console.log("updateDatahere");
  }
  // End DOM method /updateData/
